...
def create_dataset(dataset='flickr8k', captions_per_image=5,  min_word_count=5, 
                   max_len=30):
...
这一章只给出基于相应encoder、decoder的模型代码，实际encoder、decoder代码见附录。
...
![llava](E:\大三上\神经网络与深度学习课程设计\ImageCaption\llava.png)
...
if __name__ == "__main__":
    ...
    main(args)
    with open(f'/data/CourseProject/data/{dataset}/new_dataset_{dataset}.json', 'w') as fw:
        json.dump(data, fw)
```
...
![loss_pic](E:\大三上\神经网络与深度学习课程设计\ImageCaption\loss_pic.png)

### meteor

![meteor_pic](E:\大三上\神经网络与深度学习课程设计\ImageCaption\meteor_pic.png)

### cider

![cider_pic](E:\大三上\神经网络与深度学习课程设计\ImageCaption\cider_pic.png)

### bleu

![bleu_pic](E:\大三上\神经网络与深度学习课程设计\ImageCaption\bleu_pic.png)

### rouge

![rouge_pic](E:\大三上\神经网络与深度学习课程设计\ImageCaption\rouge_pic.png)
...
| -------------------------------- | ------------ | ----------- | ------------ | ------------ |
| resnet整体表示+gru               | <u>0.668</u> | 1.235       | <u>0.524</u> | <u>0.501</u> |
| renet网格表示+self attention gru | 0.635        | <u>1.28</u> | 0.481        | 0.464        |
| vit+transformer decoder          | **0.727**    | **1.618**   | **0.597**    | **0.569**    |
